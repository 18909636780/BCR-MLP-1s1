...
# Load the model
model = joblib.load('MLP1se1.pkl')
scaler = joblib.load('scaler1se1.pkl') 
...
feature_names = ["Tumor_Size_2_Years_after_Surgery", "Tumor_Grade", "Lymph_Node_Metastasis", "Numbe_of_Lymph_Nodes", "Marital_Status_Unmarried", "Marital_Status_Married", "Marital_Status_Divorced"]

# Streamlit user interface
st.title("Breast Cancer Recurrence Predictor")

# Tumor_Size_2_Years_after_Surgery
Tumor_Size_2_Years_after_Surgery = st.number_input("Tumor Size at Diagnosis(mm):", min_value=0, max_value=100, value=25)
...
# 准备输入特征
feature_values = [Tumor_Size_2_Years_after_Surgery, Tumor_Grade, Lymph_Node_Metastasis, Numbe_of_Lymph_Nodes, Marital_Status_Unmarried, Marital_Status_Married, Marital_Status_Divorced]
